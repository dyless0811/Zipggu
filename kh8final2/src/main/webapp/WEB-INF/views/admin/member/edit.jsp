...
<c:set var="memberNo" value="${memberDto.memberNo}"></c:set>
...
function formCheck() {
	if(emailCheck() && nicknameCheck() && checkNick && checkEmail){
...
<div class="wrapContainer ">
	...
	<input type="hidden" name="memberNo" class="form-control" value="${memberNo}" id="inputDefault">
		...
		<div class="infoFormItem">
			...
			<div class="infoFormItemGroup">
				<div class="infoFormItemField">
					<input type="email" name="memberEmail" class="formTextControl"  value="${memberDto.memberEmail}" oninput = "emailConfirm()" onkeyup="emailCheck();">
