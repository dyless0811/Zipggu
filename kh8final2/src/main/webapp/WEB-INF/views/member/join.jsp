...
<form method="post" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<input type="text" name="memberEmail" placeholder="이메일" autocomplete="off" required class="inputItemJ">
	</div>
	<div class="div-button">
	<button type="button" class="email-button">이메일 인증하기</button>
	</div>
	...
	<div class="row">
		...
		<input type="password" name="memberPw" placeholder="비밀번호" autocomplete="off" required class="inputItemJ">
	</div>
	</div>
	<div class="bodyForm">
	<div class="row">
		<label class="title-type">비빌번호 확인</label>
		<input type="text"  placeholder="비밀번호 확인" autocomplete="off"  required class="inputItemJ">
	</div>
	</div>
	<div class="bodyForm">
	<div class="row">
		<label class="title-type">닉네임</label>
		<div class="title-text">다른 유저와 겹치지 않는 별명을 입력해주세요. (2~15자)</div>
		<input type="text" name="memberNickname" placeholder="별명 (2~15자)" autocomplete="off"  required class="inputItemJ">
	</div>
	</div>
