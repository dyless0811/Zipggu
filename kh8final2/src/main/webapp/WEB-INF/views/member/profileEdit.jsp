...
<div class="container-400 container-center">
	...
	<form method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="text" name="memberNickname" class="form-control" value="${memberDto.memberNickname}" id="inputDefault">
		</div>
...
<!-- 				class="btn btn-outline-primary" for="btnradio1">남자</label> <input -->
<!-- 				type="radio" class="btn-check" name="btnradio" id="btnradio2" -->
<!-- 				autocomplete="off" checked=""> <label -->
<!-- 				class="btn btn-outline-primary" for="btnradio2">여자</label> -->
<!-- 		</div> -->

<!-- 		<div class="form-group"> -->
<!-- 			<label for="date" class="form-label mt-4">생년월일</label> <input -->
<!-- 				type="date"> -->
<!-- 		</div> -->
...
<!--         <button type ="button"> -->
        <c:choose>
            ...
            <c:otherwise>
            <img src="profile?memberNo=${memberProfileDto.memberNo}" width="100%" class="image image-border">
            <a href="profileDelete?memberNo=${memberProfileDto.memberNo}">삭제</a>
            </c:otherwise>
        </c:choose>
<!--         </button> -->
				</div>
